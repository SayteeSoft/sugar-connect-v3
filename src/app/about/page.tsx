      ...
      <main className="flex-grow container mx-auto p-4 md:p-6">
        <Card>
          ...
          <CardContent className="max-w-3xl mx-auto">
            ...
            <SectionTitle>Why Choose SugarConnect?</SectionTitle>
            ...
            <Paragraph>
              We move beyond the superficial. SugarConnect is for those who seek more than just a date; it's for individuals looking for mentorship, companionship, and a partnership that enriches their lives. Our platform encourages clear communication about expectations, leading to more honest and fulfilling relationships.
            </Paragraph>
