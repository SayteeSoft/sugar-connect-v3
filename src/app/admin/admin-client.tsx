                ...
                <TableBody>
                  {profiles.map(profile => (
                    <TableRow key={profile.id}>
                      ...
                      <TableCell>
                        <div className="flex items-center justify-end gap-2">
                          <Button variant="ghost" size="icon" onClick={() => handleView(profile.id)} className="dark:hover:bg-transparent dark:hover:text-foreground">
                            <Eye className="h-4 w-4" />
                            <span className="sr-only">View</span>
                          </Button>
                          <Button variant="ghost" size="icon" onClick={() => handleEdit(profile.id)} className="dark:hover:bg-transparent dark:hover:text-foreground">
                            <Pencil className="h-4 w-4" />
                            <span className="sr-only">Edit</span>
                          </Button>
                          <AlertDialog>
                              <AlertDialogTrigger asChild>
                                  <Button variant="ghost" size="icon" className="text-destructive hover:text-destructive dark:hover:bg-transparent dark:hover:text-destructive" disabled={profile.id === 1}>
