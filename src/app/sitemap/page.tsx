...
const sitemapLinks = {
  "Main Pages": [
    { href: "/", title: "Home", description: "The main landing page of SD Connect." },
      ...
      <main className="flex-grow container mx-auto p-4 md:p-6">
        <Card>
          <CardHeader>
            ...
            <p className="text-muted-foreground pt-2">Navigate through all the pages available on SD Connect.</p>
          </CardHeader>
          <CardContent>
